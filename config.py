...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7314346623:AAFU5HBpG7KJ5QAFpZ8Ql9EuCFrKLXvPcuE")
...
try:
    ADMINS=[7085541484]
    for x in (os.environ.get("ADMINS", "5857939104 5284816025 5857939104 7314346623").split()):
        ADMINS.append(int(x))
except ValueError:
